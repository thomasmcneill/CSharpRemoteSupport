    ...
    public partial class  SupportConnection : Form
    {
        ...
        public void Listener_Thread()
        {
            ...
            do
            {
                try
                {
                    lock (_StopThread)          // Check to see if we need to end this thread
                    {
                        if (StopThread)
                            return;
                    }
                    if(TransferRate.stopwatch.ElapsedMilliseconds > 2000)
                    {
                        ...
                        {
                            MessageBox.Show("TransferRate: " + e.Message);
                        }
                ...
                {
                    MessageBox.Show("Listener_Thread: " + e.Message);
